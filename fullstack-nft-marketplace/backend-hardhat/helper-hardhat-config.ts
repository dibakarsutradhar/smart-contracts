...
export const frontEndContractsFileMoralis =
  '../client-moralis/constants/networkMapping.json';
export const frontEndContractsFileGraph =
  '../client-thegraph/constants/networkMapping.json';
export const frontEndAbiLocationMoralis = '../client-moralis/constants/';
export const frontEndAbiLocationGraph = '../client-thegraph/constants';
