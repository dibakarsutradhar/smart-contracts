...
contract TokenERC20 {
    ...
    // 18 decimals is the strongly suggested default, avoid chaingig it
     ...
     *
     *  @param _spender The address authorized to send
     *  @param _value the max amount they can send
     */
     ...
     *
     *  Allows `_spender` to spend no more than `_value` tokens on your behalf, and ping the contract about it
     *
     *  @param _spender The address authorized to send
     *  @param _value the max amount they can send
